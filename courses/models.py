...
class Lesson(models.Model):
    ...
    content_file = models.FileField(upload_to='lessons/', blank=True, null=True, max_length=500)
    notes_file = models.FileField(upload_to='lesson_notes/', blank=True, null=True, max_length=500,help_text="Upload PDF Notes for this lesson")    
